...
<head>
    ...
    <meta property="og:url" content="<?php echo $URL; ?>/movies?id=<?php echo $jo->id; ?>/<?php echo $jo->original_title; ?>">
    ...
    <meta property="twitter:url" content="<?php echo $URL; ?>/movies?id=<?php echo $jo->id; ?>/<?php echo $jo->original_title; ?>">
...
<body>
    ...
    <?php echo $js1; ?>
    {
        ...
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "<?php echo $URL; ?>/movies?id=<?php echo $jo->id; ?>/<?php echo $jo->original_title; ?>"
        },
    ...
    <div class="container mx-auto aspect-w-16 aspect-h-8">
        <iframe src="https://www.2embed.to/embed/tmdb/movie?id=<?php echo $sid; ?>" scrolling="no" allowfullscreen></iframe>
    </div>
    <br>
            ...
            <span class="inline-grid grid-cols-4 sm:grid-cols-4 xl:grid-cols-10 gap-3">
                ...
                if (count($ajson) != 0) {
                    foreach ($ajson['results'] as $result) {
                        ?>
                        <span>
                            <a href="movies?id=<?php echo $result['id']; ?>/<?php echo $result['original_title']; ?>">
                                <img class="w-40" src="https://image.tmdb.org/t/p/w185<?php echo $result['poster_path']; ?>" alt="Image">
                            </a>
                        </span>
                        <?php
                    }
